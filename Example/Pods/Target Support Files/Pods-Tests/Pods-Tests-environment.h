...
// ImageCacher
#define COCOAPODS_POD_AVAILABLE_ImageCacher
#define COCOAPODS_VERSION_MAJOR_ImageCacher 0
#define COCOAPODS_VERSION_MINOR_ImageCacher 1
#define COCOAPODS_VERSION_PATCH_ImageCacher 0
